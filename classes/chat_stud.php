...
class chat_stud extends ACore_student{
	// Отправка сообщения от студента преподавателю (добавление в базу данных)
	...
	// Отображение формы для отправки сообщения и содержание чата студента с выбранным преподавателем
